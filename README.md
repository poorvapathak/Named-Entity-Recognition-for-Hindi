...
ORG entities occasionally misclassified due to overlapping tokens (e.g., भारत inside organization names).

Suffix-based rules improved recall for LOC tags.

Model fails on multi-word entities and code-mixed tokens — a limitation of HMM’s single-word emission assumption.
...
Even “old” models can perform meaningfully when engineered carefully with domain-specific heuristics.
...
🧮 Project Structure
📦 NLP_Mini_Project
 ┣ 📜 NLP_Mini-Project.ipynb
 ┣ 📊 Dataset (WikiANN Hindi)
 ┣ 📘 NLP_NER_39_41_45.pdf        ← Project Presentation
 ┣ 🧾 README.md                   ← This file
 ┗ 📈 Results and Outputs
...
✅ Correct identification of compound location entity (LOC).
